...
public class Parser {
	...
	public Parser(String s) {
		lex = new Lexer(s);
		// Author: Hossam
		// s is the query that i requested
	}
	...
	public SelectQueryData selectQuery() {
		...
		return new SelectQueryData(fields, tables, pred);
	}
	...
	public CreateViewData createView() {
		...
		lex.eatKeyword("as");
		SelectQueryData qd = selectQuery();
		//we should make it selectQuery
	...
	//Author: Hossam
	//New method QueryData
	public QueryData query() {
		QueryData qdata = new QueryData(selectQuery());
