...
public class Planner {
	...
	public Plan createQueryPlan(String qry, Transaction tx) {
		...
		SelectQueryData data = parser.selectQuery();
		//***********************************
		return qplanner.createPlan(data, tx);
		//***********************************
		
		// Author: Hossam
		// I need to know when to use createPlan and when to use
		// createSelectPlan because create plan is the one responsible for the
		// union and createSelectplan is the one responsible for the select only
	}
